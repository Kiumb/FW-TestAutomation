...
public class PrimoBollettinoPremarcato {
	...
	@Test
	@Parameters("idTest")
	public void primoBollettinoPremarcato (String idTest) throws EncryptedDocumentException, IOException, InterruptedException {
